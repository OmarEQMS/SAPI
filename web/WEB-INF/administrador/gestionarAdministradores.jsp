...
<html lang="es">
    ...
    <head>
        ...
        <title>SAPI | Administradores</title>
    ...
    <body>
        ...
        <div class="recuperarInfoAdmin" id="loading-screen" style="display: none">
            <img src="img/loading.svg">
            <p class="clear">Recuperando la información del administrador, por favor espere...</p>
        </div>

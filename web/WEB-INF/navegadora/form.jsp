...
=======
                                                        <option>PremenopÃ¡usica</option>
                                                        <option>PostmenopÃ¡usica</option>
>>>>>>> origin/Develop
                                                    </select>
                                                </div>
                                            </div>
...
=======
                                            <div class="form-group row mt-2" id="valoracionInit">
                                                ...
                                                <!-- valoracion -->
                                                <div class="col-5">
                                                    <input name="valoracionAdded" type="text" class="form-control valoracion" placeholder="Introduce valoraciÃ¯Â¿Â½n">
>>>>>>> origin/Develop
                                                </div>
...
=======
                                                        <input name="fecha-valoracionAdded" placeholder="Fecha de valoraciÃ¯Â¿Â½n" class="form-control fechaValoracion" type="text" onfocus="(this.type = 'date')">
                                                    </div>
                                                </div>

                                                <!-- boton agregar valoraciÃ³n -->
>>>>>>> origin/Develop
                                                <div class="col-2">
...
=======
                                                        <input name="fecha-espirometriaAdded" placeholder="Fecha de espirometrÃ¯Â¿Â½a" class="form-control fechaEspirometria" type="text" onfocus="(this.type = 'date')">
>>>>>>> origin/Develop
                                                    </div>
                                                </div>
